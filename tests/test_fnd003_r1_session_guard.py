...
PENDING_BATCHES: dict[str, str] = {
    ...
    "app/services/chronology.py": "T07A",
    "app/services/evidence.py": "T07A",
    "app/services/fact_review.py": "T07A",
    "app/services/followup.py": "T07A",
    "app/services/providers.py": "T07A",
