...
async def main():
    ...
    doc_content = (
        ...
        "HISTORY: Neck pain and headaches post MVA. Rear-end collision.\n"
        "EXAMINATION: Cervical tenderness at C4-C6. Limited ROM.\n"
        "Muscle spasms. MRI ordered.\n"
        "ASSESSMENT: Cervical strain. Whiplash. Rule out disc herniation.\n"
        "PLAN: Physical therapy 2x/week. Cyclobenzaprine 10mg. Referral to ortho."
    )
